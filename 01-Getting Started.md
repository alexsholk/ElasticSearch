...
Обновление первого и удаление второго документа:
    ...
    {"delete": {"_id":"2"}}
Bulk API не прерывает выполнение операций, если какая-нибудь из них не выполнилась. По завершению в ответе будут содержаться статусы всех операций в том же порядке. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwOTg5NjU5MzUsMTQxNzcwODczNSwxMz
c4NDIxMTFdfQ==
-->