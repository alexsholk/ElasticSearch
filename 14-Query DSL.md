...
#### Query-контекст 
В этом контексте условие запроса отвечает за то, *насколько хорошо* документ соответствует нашим требованиям. Помимо отбора подходящих документов также расчитывается и параметр _score (число, показывающее соответсвтие запросу)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk2NjMxODg4MSwxMjYwMDgzMzkwXX0=
-->