...
#### Query-контекст 
В этом контексте условие запроса отвечает за то, *насколько хорошо* документ соответствует нашим требованиям. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNDU4ODY5MywxMjYwMDgzMzkwXX0=
-->