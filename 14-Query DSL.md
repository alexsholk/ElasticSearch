...
Query DSL — синтаксис запросов, основанный на JSON, представляющий собой древовидную структуру, состоящую из двух типов узлов:
 ...
 - Составные — содержит простые или составные запросы, для логического объединения (bool) либо для изменения поведения (constant_score). 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk5MTg5NzA5OCwxMjYwMDgzMzkwXX0=
-->