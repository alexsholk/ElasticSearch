...
#### Filter-контекст
В этом контексте условие запроса решает, *подходит ли* данный документ или нет. При этом _score не затрагивается. Пример использования контекста фильтра 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MTk2OTk0ODQsMTI2MDA4MzM5MF19
-->