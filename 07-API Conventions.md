...
#### Fuzziness 
Параметр fuzziness позволяет управлять нечётким совпадением; может принимать значения 0, 1, 2, являющиеся т. н. расстоянием Левенштейна (количество правок)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNDM2OTI1NjMsMTIwNjMzNjQ0MywxMT
